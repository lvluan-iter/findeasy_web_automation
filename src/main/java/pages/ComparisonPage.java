...
public class ComparisonPage {
    ...
    public String getTittlePropertiesComparison(int index1, int index2) {
        ...
        String title1 = (String) ((JavascriptExecutor) driver).executeScript(
                "return arguments[0].querySelector('h3').textContent;", property1);

        String title2 = (String) ((JavascriptExecutor) driver).executeScript(
                "return arguments[0].querySelector('h3').textContent;", property2);
    ...
    public String compareTwo(int index1, int index2) {
        ...
        WebElement button = properties.get(index2).findElement(By.xpath(".//button[contains(., 'So sánh')]"));
