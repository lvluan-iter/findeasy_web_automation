...
public class RegisterPage {
    ...
    public void selectGender(String gender) {
        ui.dropdown(this.gender, UIDescriptions.GENDER, WaitType.VISIBLE).selectByVisibleText(gender);
    }
    ...
    public void register(String username, String password, String rpassword,
